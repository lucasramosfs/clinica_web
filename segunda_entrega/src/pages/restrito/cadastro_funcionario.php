...
<head>
    ...
    <title>Cadastro de Funcionário - VitaCare Clínica Médica</title>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="listagensDropdown">
                            <li><a class="dropdown-item" href="listar_funcionarios.html">
                                <i class="fas fa-users"></i> Funcionários
                            </a></li>
                            <li><a class="dropdown-item" href="listar_medicos.html">
                                <i class="fas fa-user-md"></i> Médicos
                            </a></li>
                            <li><a class="dropdown-item" href="listar_agendamentos.html">
                                <i class="fas fa-calendar-alt"></i> Agendamentos
                            </a></li>
                            <li><a class="dropdown-item" href="listar_contatos.html">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <h1 class="display-4 fade-in-up">Cadastro de Funcionário</h1>
                    <p class="lead fade-in-up">Preencha os dados para cadastrar um novo funcionário</p>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0"><i class="fas fa-user-plus"></i> Dados do Funcionário</h4>
                        </div>
                        <div class="card-body">
                            <div id="alert-container"></div>
                            
                            <form id="cadastroFuncionarioForm" action="../../../api/cadastrar_funcionario.php" method="post">
                                <div class="row">
