...
<head>
    ...
    <title>Listar Funcionários - VitaCare Clínica Médica</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <h1 class="display-4 fade-in-up">Listagem de Funcionários</h1>
                    <p class="lead fade-in-up">Visualize e gerencie os funcionários cadastrados</p>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0"><i class="fas fa-users"></i> Funcionários Cadastrados</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="funcionarios-table-body">
                                        <!-- Dados dos funcionários serão carregados aqui via JavaScript -->
                                    </tbody>
                                </table>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editarFuncionarioModalLabel">
                    ...
                    <form id="formEditarFuncionario" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" class="form-control" id="editSenha" placeholder="Deixe vazio para não alterar">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="editEstadoCivil" class="form-label">Estado Civil *</label>
                                <select class="form-control" id="editEstadoCivil" name="editEstadoCivil" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <h5>Tem certeza que deseja excluir este funcionário?</h5>
    ...
    <script src="../../js/listar_funcionarios.js"></script>
