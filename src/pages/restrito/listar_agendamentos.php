...
<head>
    ...
    <title>Listar Agendamentos - VitaCare Clínica Médica</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <h1 class="display-4 fade-in-up">Listagem de Agendamentos</h1>
                    <p class="lead fade-in-up">Visualize e gerencie os agendamentos de consultas</p>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0"><i class="fas fa-calendar-alt"></i> Agendamentos Realizados</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="agendamentos-table-body">
                                        <!-- Dados dos agendamentos serão carregados aqui via JavaScript -->
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <!-- Modal Confirmar Cancelamento de Agendamento -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <h5>Tem certeza que deseja cancelar este agendamento?</h5>
                        <p class="text-muted mb-4">Esta ação não poderá ser desfeita.</p>
                        <div class="alert alert-light border">
                            <strong>Paciente:</strong> <span id="pacienteParaCancelar"></span><br>
                            <strong>Data:</strong> <span id="dataParaCancelar"></span> às <span id="horaParaCancelar"></span>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" onclick="confirmarCancelamento()">
                        <i class="fas fa-calendar-times"></i> Cancelar Agendamento
                    </button>
                </div>
            </div>
        </div>
    ...
    <script src="../../js/listar_agendamentos.js"></script>
